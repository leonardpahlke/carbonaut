...
[Download the latest release](https://github.com/leonardpahlke/carbonaut/releases) of Carbonaut for your platform, then extract it.
...
Caronaut is running and measures energy consumption through the <Link href="/plugins/scaphandre">Scaphandre plugin</Link> 🎉.
</Steps>
